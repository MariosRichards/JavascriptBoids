...
//	alert(this.canvasScale);
   ...
   // note - am assuming canvas won't change size!!
	...
	this.ruleCoeffs[0][7] = [0, 3, 0, 0,    0,    0]; // PARIAH BOID                PERCEPT TYPE 7	
	...
	this.ruleCoeffs[1][7] = [1, 1, 1, 0,    0,    0]; // PARIAH BOID                PERCEPT TYPE 7
	...
	this.ruleCoeffs[2][4] = [0, 0, 0, 0,    0,    0]; // boid2    					PERCEPT TYPE 4
	...
	this.ruleCoeffs[2][7] = [0, 0, 0, 0,    0,    0]; // PARIAH BOID                PERCEPT TYPE 7
