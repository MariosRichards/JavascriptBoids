...
//	alert(this.canvasScale);
   ...
   // note - am assuming canvas won't change size!!
	...
	this.ruleCoeffs[1][4] = [1, 1.5, 0.2, 0,    0,  0]; // FRIEND BOID				PERCEPT TYPE 4
	...
	this.ruleCoeffs[1][7] = [0, 100, 0, 0,    0,    0]; // PARIAH BOID                PERCEPT TYPE 7
	...
	this.ruleCoeffs[2][2] = [1, 0.5, 0, 0,  0,    0]; // boid       				PERCEPT TYPE 2
